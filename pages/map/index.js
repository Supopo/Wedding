...
Page({
  ...
  data: {
    ...
    mainInfo: {
      ...
      he_tel:'15667073887',
      she_tel: '18966844949',
      lng: '107.1332135796547',
      lat: '34.64250026622392',
      hotel: '千阳宾馆',
  ...
  markertap(e) {
    // console.log(e)
    var lng = this.data.mainInfo.lng
    var lat = this.data.mainInfo.lat
    console.log(lat)
    wx.openLocation({
  ...
  onLoad: function(options) {
    ...
    var lng = that.data.mainInfo.lng
    var lat = that.data.mainInfo.lat
    that.setData({
